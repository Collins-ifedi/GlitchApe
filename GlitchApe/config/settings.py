...
# Hosts
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "localhost,127.0.0.1,glitchape.fun,glitchape-by.onrender.com").split(",")
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://glitchape.fun",
    "https://glitchape-by.onrender.com",
]

# ✅ Security (important for production on Render)
