...
# -----------------------
# Models (Definitions moved to models.py)
# -----------------------

# All model definitions (User, VerificationToken, ResetToken,
# ChatSession, ChatMessage, OrderRecord) have been moved to models.py
...
async def get_current_user(token: str = Depends(oauth2_scheme), db: AsyncSession = Depends(get_db)):
    ...
    q = select(User).where(User.email == user_email) # User model imported from models.py
