...
HF_API_URL = "https://router.huggingface.co/v1/models/stabilityai/stable-diffusion-xl-base-1.0"
...
class GlitchApeCentralHandler:
    ...
    def _validate_and_update_variant(self, draft_details: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        ...
        for variant in self.variant_list:
            ...
            if target_category in category and target_size == size and target_color == color:
