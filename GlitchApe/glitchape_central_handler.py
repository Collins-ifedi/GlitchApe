...
class GlitchApeCentralHandler:
    ...
    async def _call_gemini_brain(self, prompt_parts: List[str | Dict[str, Any]], history: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def handle_chat_message(self, session_id: uuid.UUID, prompt: str, uploaded_image: Optional[UploadFile] = None) -> LiveChatResponse:
        ...
        gemini_prompt_parts: List[str | Dict[str, Any]] = []
        ...
        if uploaded_image and uploaded_image.filename:
            try:
                ...
                image_part = {"mime_type": mime_type_for_analysis, "data": image_bytes_for_analysis}
